...
################################################################################################
class AnalogGaugeWidget2(QWidget):
    ...
    def __init__(self, parent=None):
        super(AnalogGaugeWidget2, self).__init__(parent)
        ...
        self.initial_scale_fontsize = 24
        ...
        self.initial_value_fontsize = 60
        ...
        self.outer_circle_bg =  [
                                [0.0645161, QColor(255,255,77,255)], 
                                [0.37788, QColor(255,128,0,255)], 
